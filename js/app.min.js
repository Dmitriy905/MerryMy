...
//Главный слайдер
let bodySlider = new Swiper('.page__slider', {
	observer: true,
	observeParents: true,
	slidesPerView: 1,
	spaceBetween: 30,
...
// Шаблоны
let templates_sliders1 = new Swiper('.templates__slider', {
	observer: true,
	observeParents: true,
	slidesPerView: 1,
	spaceBetween: 30,
...
//PROVENCE===========================================
let slider_header = new Swiper('.pr-menu__list', {
	observer: true,
	observeParents: true,
	slidesPerView: 3,
	spaceBetween: 0,
    ...
    navigation: {
		nextEl: '.pr-menu__arrow-next',
		prevEl: '.pr-menu__arrow-prev',
	},
	on: {
...
//= ================
// Menu
const iconMenu = document.querySelector('.icon-menu, .pr-header__icon');
if (iconMenu != null) {
  const delay = 500;
  const menuBody = document.querySelector('.menu__body, .pr-menu__body');
...
const bg = document.querySelectorAll('.pd-decor');
